    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nested_documents', models.ManyToManyField(blank=True, to='tariff.nesteddocuments', verbose_name='Вложенные документы')),
                ('tags', models.ManyToManyField(blank=True, to='tariff.tags', verbose_name='Теги')),
            ],
            options={
                'verbose_name': 'Статья',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article', models.ManyToManyField(blank=True, to='tariff.tariffarticles', verbose_name='Статьи')),
                ('category_documents', models.ManyToManyField(blank=True, to='tariff.categorydocuments', verbose_name='Документы')),
            ],
            options={
