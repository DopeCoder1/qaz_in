...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ObstacleArticles',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=100, verbose_name='Заголовок')),
                ('content', models.TextField(verbose_name='Контент')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Дата создания')),
                ('nested_documents', models.ManyToManyField(blank=True, to='obstacle.nesteddocuments', verbose_name='Вложенные документы')),
                ('tags', models.ManyToManyField(blank=True, to='obstacle.tags', verbose_name='Теги')),
            ],
            options={
                'verbose_name': 'Статья',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article', models.ManyToManyField(blank=True, to='obstacle.obstaclearticles', verbose_name='Статьи')),
                ('category_documents', models.ManyToManyField(blank=True, to='obstacle.categorydocuments', verbose_name='Документы')),
            ],
            options={
