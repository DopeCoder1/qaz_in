    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('executor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='strategy.executor', verbose_name='Исполнитель')),
                ('form_realization', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='strategy.formrealization', verbose_name='Форма реализации')),
                ('nested_documents', models.ManyToManyField(blank=True, to='strategy.nesteddocuments', verbose_name='Вложенные документы')),
            ],
            options={
                'verbose_name': 'Статья',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subcategory1', models.ManyToManyField(blank=True, to='strategy.category', verbose_name='Выбор категории 1-уровня')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article', models.ManyToManyField(blank=True, to='strategy.strategyarticles', verbose_name='Статьи')),
                ('subcategory2', models.ManyToManyField(blank=True, to='strategy.subcategory', verbose_name='Выбор категории 2-уровня')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='tags',
            field=models.ManyToManyField(blank=True, to='strategy.tags', verbose_name='Теги'),
        ),
        migrations.AddField(
            model_name='category',
            name='category_documents',
            field=models.ManyToManyField(blank=True, to='strategy.categorydocuments', verbose_name='Документы'),
        ),
    ]
